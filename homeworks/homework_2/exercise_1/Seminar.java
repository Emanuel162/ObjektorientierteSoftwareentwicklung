package homeworks.homework_2.exercise_1;

import java.util.ArrayList;
import java.util.List;

public class Seminar<T> {
    private String name;
    private String id;
    ...
    public List<T> getParticipantsFromStudyProgram(String subject) {
        return participants.stream().filter((T participant) -> subject.equals(((IStudent) participant).getSubject())).toList();
    }


    // Wildcards aren't necessary because we need the generic type more than once
